...
vastaan. Yksityiskohtaisempia esimerkkejä paketin käytöstä Suomi-datan
penkomiseen löydät
Louhos-blogista\footnote{http://louhos.wordpress.com}.


%\section{Paketin lataaminen}
...
paketista on apua, toivomme viittausta työhön \cite{sorvi11}.
