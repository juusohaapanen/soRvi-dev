...
install.packages(c("methods", "ggplot2"))
install.packages(c("gpclib", "mapproj"))
install.packages(c("maps", "maptools"))
install.packages(c("plyr", "pxR"))
install.packages(c("ReadImages", "rgdal"))
install.packages(c("rgeos", "RgoogleMaps"))
install.packages(c("sp", "XML"))
@
...
shape.file <- system.file("extdata/Maanmittauslaitos/1-milj-Shape-etrs-shape/forest.shp", package = "sorvi")  
