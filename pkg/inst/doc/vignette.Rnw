...
(SYKE) OIVA-palvelu\footnote{www.ymparisto.fi/oiva}
sisältää lukuisia avoimia aineistoja. Aineistot ovat saatavilla sekä 
latauspalvelun että WMS-rajapinnan kautta. OIVA-palvelu vaati ilmaisen 
käyttäjätunnuksen, WMS-palvelu ei edellytä tunnusta.
...
suomen.postinumerot <- get.postal.codes()
@
...
kunta.maakunta <- municipality2province(kunnat, municipality.info)
@
