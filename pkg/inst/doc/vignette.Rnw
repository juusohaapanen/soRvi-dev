...
ja kommentteja näidenkin osalta. XML-paketti vaatii
'libxml2-dev'-palikan asennusta esim pakettienhallinnasta; rgdal- ja
rgeos-pakettien asennus edellyttää GEOS:n asennusta
...
(http://trac.osgeo.org/proj/). Nyt riippuvuudet pitäisi asentua R:ssä
komennolla:

<<initial, results = hide, eval = FALSE>>=
install.packages(c("methods", "ggplot2", "gpclib", "mapproj", "maps", "maptools", "plyr", "ReadImages", "RgoogleMaps", "XML", "rgeos", "sp", "rgdal"))
@
