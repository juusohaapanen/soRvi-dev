...
'libgdal1-dev'-palikkaa. Nyt riippuvuudet pitäisi asentua R:ssä
komennolla:

<<initial, results = hide, eval = FALSE>>=
install.packages(c("methods", "ggplot2", "gpclib", "mapproj", "maps", "maptools", "plyr", "ReadImages", "RgoogleMaps", "XML", "rgeos", "sp", "rgdal", "pxR"))
@
